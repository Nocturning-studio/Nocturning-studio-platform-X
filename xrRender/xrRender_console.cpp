...
void xrRender_initconsole()
{
	...
	CMD4(CCC_Float, "r_autoexposure_lowlum", &ps_r_autoexposure_low_lum, 0.0001f, 1.0f);
	CMD4(CCC_Float, "r_autoexposure_amount", &ps_r_autoexposure_amount, 0.0000f, 1.0f);
	...
	CMD3(CCC_Mask, "r_disable_shading", &ps_r_shading_flags, RFLAG_DISABLED_SHADING);
