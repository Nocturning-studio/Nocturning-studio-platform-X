...
void CRenderTarget::create_textures()
{
	...
	// G-Buffer
	{
		...
		else
		{
			rt_GBuffer_1.create(r_RT_GBuffer_1, dwWidth, dwHeight, D3DFMT_A8R8G8B8);
			rt_GBuffer_2.create(r_RT_GBuffer_2, dwWidth, dwHeight, D3DFMT_A8R8G8B8);
			rt_GBuffer_3.create(r_RT_GBuffer_3, dwWidth, dwHeight, D3DFMT_A2R10G10B10);
			rt_GBuffer_4.create(r_RT_GBuffer_4, dwWidth, dwHeight, D3DFMT_G16R16F);
		}
	}
	...
	//rt_ReflectionsRaw.create(r_RT_reflections_raw, u32(dwWidth * 0.75f), u32(dwHeight * 0.75f), D3DFMT_A16B16G16R16F);
