...
void CBlender_BmmD::Compile(CBlender_Compile& C)
{
	...
	case SE_NORMAL_HQ: // deffer
		...
		C.r_Define(BumpType == 1, "USE_NORMAL_MAPPING", "1");
		C.r_Define(BumpType == 2, "USE_PARALLAX_MAPPING", "1");
		C.r_Define(BumpType == 3, "USE_PARALLAX_OCCLUSION_MAPPING", "1");
		C.r_Define(true, "USE_SRGB_COLOR_CONVERTING", "1");
		C.r_Define(true, "USE_DETAIL_SRGB_COLOR_CONVERTING", "1");
		...
		if (ps_r_material_quality > 0 && !ps_r_shading_flags.test(RFLAG_FLAT_SHADING))
		{
			...
			C.r_Sampler("s_dn_b", strconcat(sizeof(mask), mask, oB_Name, "_bump"), false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC, false);
			C.r_Sampler("s_dn_a", strconcat(sizeof(mask), mask, oA_Name, "_bump"), false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC, false);

			C.r_Sampler("s_dn_rX", strconcat(sizeof(mask), mask, oR_Name, "_bump#"), false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC, false);
			C.r_Sampler("s_dn_gX", strconcat(sizeof(mask), mask, oG_Name, "_bump#"), false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC, false);
			C.r_Sampler("s_dn_bX", strconcat(sizeof(mask), mask, oB_Name, "_bump#"), false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC, false);
			C.r_Sampler("s_dn_aX", strconcat(sizeof(mask), mask, oA_Name, "_bump#"), false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC, false);
		}
