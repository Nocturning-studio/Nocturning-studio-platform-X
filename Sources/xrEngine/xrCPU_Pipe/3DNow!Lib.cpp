...
// явное приведение типов дл€ устранени€ предупреждений
static const __m64i pinfs = {(int)0x7f800000, (int)0x7f800000};		// dword PINH, PINH
static const __m64i smh_masks = {(int)0x807fffff, (int)0x807fffff}; // dword MASKSMH, MASKSMH
static const __m64i sign_mask = {(int)0x7fffffff, (int)0x7fffffff};
...
// »зменено им€ с 'bnd' на 'bound_val' чтобы избежать конфликта с зарезервированным словом
static const __int32 bound_val = 0x3F133333;
...
__declspec(naked) void a_acos()
{
	__asm
	{
        ...
        movq        mm5, mm0 //; save z
        pfmul       mm0, mm4 //; z*0.5
        movd        mm2, [bound_val] //; 0.575 (»«ћ≈Ќ≈Ќќ: было bnd)
