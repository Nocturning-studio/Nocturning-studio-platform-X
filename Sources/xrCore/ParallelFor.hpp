...
template <typename T> class TaskRange
{
  public:
...
namespace details
{
template <typename Range, typename Function> class ParallelForTask
{
  public:
	...
	static decltype(auto) Run(const Range& range, bool wait, const Task::OnFinishFunc& callback,
...
template <typename Range, typename Function>
decltype(auto) xr_parallel_for(const Range& range, bool wait, const Task::OnFinishFunc& callback,
							   const Function& function)
{
