  ...
  public:
	...
	void Compile(CBlender_Compile& C)
	{
		...
		case SE_MASK_SPOT: // spot or omni-part
			C.begin_Pass("accumulating_light_stage_mask", "dumb", false, TRUE, FALSE);
			gbuffer(C);
			C.end_Pass();
			break;
		...
		case SE_MASK_DIRECT: // stencil mask for directional light
			C.begin_Pass("screen_quad", "accumulating_light_stage_sun_mask", false, FALSE, FALSE, TRUE, D3DBLEND_ZERO, D3DBLEND_ONE, TRUE, 1);
			gbuffer(C);
			C.end_Pass();
			break;
		}
