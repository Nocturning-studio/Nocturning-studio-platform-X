  ...
  public:
	...
	virtual void Compile(CBlender_Compile& C)
	{
		...
		case SE_PRECOMBINE_SCENE:
			...
			C.r_Sampler_point("s_light_accumulator", r_RT_Light_Accumulator);
			C.r_Sampler_point("s_ao", r_RT_ao);
			...
			C.r_Sampler_linear("s_brdf_lut", "vfx\\vfx_brdf_lut");
		...
		case SE_COMBINE_SCENE:
			...
			C.r_Sampler_linear("s_reflections", r_RT_reflections);
		...
		case SE_COMBINE_POSTPROCESS:
			...
			C.r_Sampler_linear("s_autoexposure", r_RT_autoexposure_cur);
			C.r_Sampler_linear("s_bloom", r_RT_bloom1);
			C.r_Sampler_linear("s_bloom_blades", r_RT_bloom_blades1);
			C.r_Sampler_point("s_light_accumulator", r_RT_Light_Accumulator);
		...
		case SE_COMBINE_VOLUMETRIC:
			...
			C.r_Sampler_point("s_image", r_RT_generic1);
			C.r_Sampler_linear("s_volumetric_accumulator", r_RT_Volumetric_Sun);
