  ...
  public:
	...
	virtual void Compile(CBlender_Compile& C)
	{
		...
		case SE_NORMAL_LQ: // deffer
			...
			{
			case 0:
				C.r_Pass("gbuffer_stage_particle", "gbuffer_stage_particle", FALSE, TRUE, TRUE, FALSE, D3DBLEND_ONE, D3DBLEND_ZERO, FALSE, 200);
				break; // SET
			case 1:
			...
			C.r_Sampler("s_base", C.L_textures[0], false, oClamp.value ? D3DTADDRESS_CLAMP : D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC, true);
			gbuffer(C);
			C.r_End();
			break;
