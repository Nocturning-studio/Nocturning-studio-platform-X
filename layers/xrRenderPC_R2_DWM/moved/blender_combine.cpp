...
void CBlender_combine::Compile(CBlender_Compile& C)
{
	...
	{
	case 0:
		C.r_Pass("simple_quad_tm", "combine_1", FALSE, FALSE, FALSE, TRUE, D3DBLEND_INVSRCALPHA, D3DBLEND_SRCALPHA);
		C.r_Stencil(TRUE, D3D11_COMPARISON_LESS_EQUAL, 0xff, 0x00);
		C.r_StencilRef(0x01);
	...
	case 3:
		C.r_Pass("simple_quad_tm", "combine_volumetric", FALSE, FALSE, FALSE, TRUE, D3DBLEND_ONE, D3DBLEND_ONE, 2, FALSE);
