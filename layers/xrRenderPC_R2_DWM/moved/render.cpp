...
void CRender::update_options()
{
	...
	//		o.msaa_samples = 1;
	//		o.txaa = FALSE;
	//		Msg("* Antialiasing type: disabled");
	//		break;
	//	case AA_MLAA:
	//		o.aa_mode = AA_MLAA;
	//		o.msaa_samples = 1;
	//		o.txaa = FALSE;
	//		Msg("* Antialiasing type: MLAA");
	//		break;
	//	case AA_FXAA:
	//		o.aa_mode = AA_FXAA;
	//		o.msaa_samples = 1;
	//		o.txaa = FALSE;
	//		Msg("* Antialiasing type: FXAA");
	//		break;
	//	case AA_MSAA_FXAA:
	//		o.aa_mode = AA_MSAA;
	//		o.msaa_samples = 2;
	//		o.txaa = FALSE;
	//		Msg("* Antialiasing type: MSAA + FXAA");
	//		break;
	//	case AA_MSAA2S:
	//		o.aa_mode = AA_MSAA;
	//		o.msaa_samples = 2;
	//		o.txaa = FALSE;
	//		Msg("* Antialiasing type: MSAA 2X");
	//		break;
	//	case AA_MSAA4S:
	//		o.aa_mode = AA_MSAA;
	//		o.msaa_samples = 4;
	//		o.txaa = FALSE;
	//		Msg("* Antialiasing type: MSAA 4X");
	//		break;
	//	case AA_MSAA8S:
	//		o.aa_mode = AA_MSAA;
	//		o.msaa_samples = 8;
	//		o.txaa = FALSE;
	//		Msg("* Antialiasing type: MSAA 8X");
	//		break;
	//	case AA_TAA:
	//		o.aa_mode = AA_TAA;
	//		o.msaa_samples = 1;
	//		o.txaa = FALSE;
	//		Msg("* Antialiasing type: TAA");
	//		break;
	//	case AA_TAA_V2:
	//		o.aa_mode = AA_TAA_V2;
	//		o.msaa_samples = 1;
	//		o.txaa = FALSE;
	//		Msg("* Antialiasing type: TAA V2");
	//		break;
	//	case AA_TXAA:
	//		o.aa_mode = AA_TXAA;
	//		o.msaa_samples = 1;
	//		o.txaa = TRUE;
	//		Msg("* Antialiasing type: TXAA");
	//		break;
	//	case AA_TXAA2S:
	//		o.aa_mode = AA_MSAA;
	//		o.msaa_samples = 2;
	//		o.txaa = TRUE;
	//		Msg("* Antialiasing type: TXAA 2X");
	//		break;
	//	case AA_TXAA4S:
	//		o.aa_mode = AA_MSAA;
	//		o.msaa_samples = 4;
	//		o.txaa = TRUE;
	//		Msg("* Antialiasing type: TXAA 4X");
	//		break;
	//	}
	//
	...
	if (o.sun_il || o.spot_il || o.ssao == SSAO_PATH_TRACING)
	{
...
CShaderMacros CRender::FetchShaderMacros()
{
	...
	*/
	...
	// shadow map
	{
		...
		macros.add(TRUE, "SMAP_size", c_smap);
	...
	//append_shader_option(&options, &sh_name,
	//					 o.advanced_mode && (o.aa_mode == AA_TAA || o.aa_mode == AA_TAA_V2 || o.txaa == TRUE),
	//					 "USE_TAA", "1");
	...
	//append_shader_option(&options, &sh_name,
	//					 o.advanced_mode && o.msaa_samples_reflections > 1 &&
