...
void CBlender_sunshafts::Compile(CBlender_Compile& C)
{
	...
	case 1:
		C.r_Pass("simple_quad", "sunshafts_dwm_denoise_apply", FALSE, FALSE, FALSE, TRUE, D3DBLEND_ONE, D3DBLEND_ONE);
...
{
	C.r_Pass(ps, vs, FALSE, FALSE, FALSE, TRUE, D3DBLEND_ONE, D3DBLEND_ONE);
