...
void CBlender_sky::Compile(CBlender_Compile& C)
{
	...
	case SE_CLOUDS:
		C.r_Pass("clouds", "clouds", FALSE, FALSE, FALSE, TRUE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA, 3, TRUE);
	...
	case SE_CLOUDS1:
		C.r_Pass("planar_clouds", "clouds", FALSE, FALSE, FALSE, TRUE, D3DBLEND_SRCALPHA, D3DBLEND_INVSRCALPHA, 3, TRUE);
		C.r_dx10Texture("s_clouds0", "$null");
		C.r_dx10Texture("s_clouds1", "$null");
		C.r_dx10Texture("s_tonemap", tex_t_LUM_dest);
		C.r_dx10Sampler("smp_nofilter");
