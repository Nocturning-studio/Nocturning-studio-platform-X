...
public:
	...
	float														o_sun			;
	ID3D11Query*													q_sync_point[CHWCaps::MAX_GPUS];
	u32															q_sync_count	;
...
public:
	...
	ID3D11Buffer*						getVB						(int id, BOOL	_alt=FALSE);
	ID3D11Buffer*						getIB						(int id, BOOL	_alt=FALSE);
...
public:
	...
	ID3D11Resource*				texture_load				(LPCSTR	fname, u32& msize, bool bStaging = false);
...
private:
	xr_vector<D3D11_SHADER_MACRO>									m_ShaderOptions;
