...
public:
	...
	ID3D11Texture2D*			t_ss_async;				//32bit		(r,g,b,a) is situated in the system memory
	...
	ID3D11Texture2D*			t_noise_surf_mipped;
...
private:
	...
	ID3D11Buffer*				g_accum_volumetric_vb;
	ID3D11Buffer*				g_accum_volumetric_ib;
...
public:
	...
	void						u_setrt					(u32 W, u32 H, ID3D11RenderTargetView* _1, ID3D11RenderTargetView* _2 = NULL, ID3D11RenderTargetView* _3 = NULL, ID3D11RenderTargetView* _4 = NULL);
	void						u_setrt					(const ref_rt& _1, const ref_rt& _2 = NULL, const ref_rt& _3 = NULL, const ref_rt& _4 = NULL);
	void						u_setzb					(ID3D11DepthStencilView* zb);
