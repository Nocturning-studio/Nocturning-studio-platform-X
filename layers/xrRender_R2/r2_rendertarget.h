...
public:
	...
	void						u_setrt					(const ref_rt& _1, const ref_rt& _2, const ref_rt& _3, ID3D11DepthStencilView* zb);
	void						u_setrt					(const ref_rt& _1, const ref_rt& _2, const ref_rt& _3, const ref_rt& _4, ID3D11DepthStencilView* zb);
	void u_setrt(u32 W, u32 H, ID3D11RenderTargetView* _1, ID3D11RenderTargetView* _2, ID3D11RenderTargetView* _3,
	...
	void						phase_TAA_define		(u32* pTAA_samples);
	void						phase_TAA_prepare		();
	void						phase_TAA_apply			();
