...
void CBlender_autoexposure::Compile(CBlender_Compile& C)
{
	...
	case 0:
		...
		C.r_Sampler_gaussian("s_image", r2_RT_generic1);
		C.r_End();
		break;
	case 1:
		C.r_Pass("null", "postprocess_stage_autoexposure_pass_downsampling_step_2", false, FALSE, FALSE, FALSE);
		C.r_Sampler_gaussian("s_image", r2_RT_autoexposure_t512);
		C.r_End();
		break;
	case 2:
		C.r_Pass("null", "postprocess_stage_autoexposure_pass_downsampling_step_2", false, FALSE, FALSE, FALSE);
		C.r_Sampler_gaussian("s_image", r2_RT_autoexposure_t256);
		C.r_End();
		break;
	case 3:
		C.r_Pass("null", "postprocess_stage_autoexposure_pass_downsampling_step_2", false, FALSE, FALSE, FALSE);
		C.r_Sampler_gaussian("s_image", r2_RT_autoexposure_t128);
		C.r_End();
		break;
	case 4:
		C.r_Pass("null", "postprocess_stage_autoexposure_pass_downsampling_step_2", false, FALSE, FALSE, FALSE);
	...
	case 5:
		...
		C.r_Sampler_rtf("s_image", r2_RT_autoexposure_t8);
