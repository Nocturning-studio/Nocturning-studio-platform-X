...
void CRenderTarget::accum_point_geom_create()
{
	...
	// vertices
	{
		...
		u32 vSize = 3 * 4;
		//R_CHK(HW.pDevice11->CreateVertexBuffer(vCount * vSize, dwUsage, 0, D3DPOOL_MANAGED, &g_accum_point_vb, 0));
		//BYTE* pData = 0;
	...
	// Indices
	{
		...
		//BYTE* pData = 0;
		//R_CHK(
		//	HW.pDevice11->CreateIndexBuffer(iCount * 2, dwUsage, D3DFMT_INDEX16, D3DPOOL_MANAGED, &g_accum_point_ib, 0));
