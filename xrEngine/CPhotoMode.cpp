...
BOOL CPhotoMode::ProcessCam(SCamEffectorInfo& info)
{
	...
	else
	{
		...
		#pragma todo(Deathman to Deathman: ƒобавить ограничение дальности полета дл€ избегани€ читинга)
...
#ifndef MASTER_GOLD
#pragma todo("Deathman to all: ѕеределать быструю отладку рендера под удобный вид")
	if (dik == DIK_1)
