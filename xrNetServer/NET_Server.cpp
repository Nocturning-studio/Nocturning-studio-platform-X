...
void IClient::_SendTo_LL(const void* data, u32 u32size, u32 u32flags, u32 u32timeout)
{
	R_ASSERT(server);
	server->IPureServer::SendTo_LL(ID, const_cast<void*>(data), u32size, u32flags, u32timeout);
}
